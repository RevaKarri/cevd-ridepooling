...
#from keras.layers import Input, LSTM, Dense, Embedding, TimeDistributed, Masking, Concatenate, Flatten, Bidirectional, LeakyReLU, Attention  # type: ignore
...
#import tensorflow as tf; keras_function = tf.compat.v1.keras.backend.function  # type: ignore
#from keras.layers import Input, LSTM, Dense, Embedding, TimeDistributed, Masking, Concatenate, Flatten, Bidirectional, LeakyReLU, Attention as KerasAttention  # type: ignore
#from keras.models import Model, load_model, clone_model  # type: ignore

# Custom wrapper to bypass the Keras 3 BroadcastTo mask bug
#class SafeAttention(KerasAttention):
#    def call(self, inputs, mask=None, **kwargs):
#        return super().call(inputs, mask=None, **kwargs)
#    def compute_mask(self, inputs, mask=None):
#        return None

#Attention = SafeAttention

#keras_function = custom_keras_function
import random
import tensorflow as tf
keras_function = tf.compat.v1.keras.backend.function
